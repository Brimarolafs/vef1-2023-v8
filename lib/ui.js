...
export function submitOrder(name, address) {
  const formDivLabelElement = document.querySelector('.receipt .receipt-message');
  if (!formDivLabelElement) {
    console.warn('fann ekki .form div label');
    return;
  }
